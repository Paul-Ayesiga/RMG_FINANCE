    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <x-wireui-select wire:model="reportType" id="reportType"
            ...
            <div>
                ...
                <x-wireui-input type="date" wire:model="startDate" id="startDate"
            ...
            <div>
                ...
                <x-wireui-input type="date" wire:model="endDate" id="endDate"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
            </div>
        ...
        @if($reportData && count($reportData) > 0)
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        @foreach($reportData->first() ?? [] as $column => $value)
